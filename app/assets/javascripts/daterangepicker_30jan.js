        ...
        updateInputText: function() {
            if (this.element.is('input'))
                this.element.val(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
            		var fromDate = encodeURIComponent(this.container.find('input[name=daterangepicker_start]').val());
			var toDate = encodeURIComponent(this.container.find('input[name=daterangepicker_end]').val());
			var hostname = "http://"+window.location.hostname+":3000/preview/setdates";
			$.ajax({
				type: "GET",
				url: hostname,
				data: "fromDate=" + fromDate + "&toDate=" + toDate + "&value=14",
